      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-gray-50 p-10 rounded-2xl flex flex-col items-center w-full max-w-3xl shadow-2xl cursor-default relative overflow-hidden"
          >
            {/* Project Details */}
            ...
            <div className="text-center relative z-10">
              <button
                ...
                className="bg-primary hover:bg-opct px-4 py-2 text-white hover:text-primary font-semibold font-teko text-xl rounded text-center w-fit mx-auto cursor-pointer"
              >
                Understood!
              </button>
            </div>
