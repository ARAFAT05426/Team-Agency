          ...
          <div className="flex flex-col px-5 py-10 flex-1 gap-3">
            ...
            <div className="space-y-5 flex-1">
              ...
              <p className="max-w-sm font-medium opacity-75">
                ...
                sporting events, and even a memorial service. Donec lectus enim,
                dapibus sed augue nec, adipiscing elit. Curabitur vulputate
                vestibulum rhoncus, dolor eget viverra pretium, dolor tellus
                aliquet nunc, vitae ultricies erat elit eu lacus. Vestibulum non
                justo fun […]
              </p>
            </div>
            <Link
