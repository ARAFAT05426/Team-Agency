      ...
      <div className="py-20 w-full lg:w-container mx-auto px-4 lg:px-20">
        ...
        <div className="p-0 lg:p-5 flex flex-col md:flex-row items-start md:gap-36">
          <div className="space-y-10 w-full lg:w-2/3">
            ...
            <Fade direction="left" duration={1000} delay={400}>
            ...
            <Fade direction="left" duration={1000} delay={500}>
              <div className="bg-controller rounded shadow-lg w-full max-w-full md:max-w-xl space-y-5 px-6 py-8">
                {achievements.map((achievement, i) => (
                  <Fade duration={1000} delay={i * 200} key={i}>
                    <div
                    ...
                    >
                      ...
                      <Image
                        className={`${
                          achievement.profit.includes("2.3M")
                            ? "rotate-180"
                            : ""
                        } hidden lg:flex`}
          ...
          <div className="w-full md:w-1/3 mx-auto space-y-5 mt-10 lg:mt-0">
            {overview.map((item, i) => (
              <Zoom duration={1000} delay={100 * i} key={i}>
                <div className="h-40 w-full md:w-52 bg-white shadow-lg rounded-md flex flex-col items-center gap-4 p-6 z-[1] border-b-8 border-b-transparent hover:border-b-primary transition-all duration-500">
                  <Image
                    src={item.icon}
                    alt="overview icon"
                    className="w-10 h-10"
