...
const TestimonialSlide = () => {
  const testimonials = [
    {
      message: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, repellat! Dignissimos ipsum quibusdam tenetur, quidem est aut voluptas perferendis culpa laborum ratione minima quia! Accusamus saepe quis, excepturi a ipsa vel alias at laborum maxime.",
      clientName: "John Doe",
      clientPosition: "CEO, Example Corp",
      clientImage: "/about/author-6.png",
    },
    {
      message: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, repellat! Dignissimos ipsum quibusdam tenetur, quidem est aut voluptas perferendis culpa laborum ratione minima quia! Accusamus saepe quis, excepturi a ipsa vel alias at laborum maxime.",
      clientName: "Jane Smith",
      clientPosition: "CTO, Sample Inc",
      clientImage: "/public/about/author-9.png",
    },
    {
      message: "Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae, repellat! Dignissimos ipsum quibusdam tenetur, quidem est aut voluptas perferendis culpa laborum ratione minima quia! Accusamus saepe quis, excepturi a ipsa vel alias at laborum maxime.",
      clientName: "Mark Johnson",
      clientPosition: "Manager, Company XYZ",
      clientImage: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
  ...
  return (
    <div className="relative w-full max-w-sm md:max-w-2xl pl-0 lg:pl-5">
      ...
      >
        ...
        <div className="absolute w-24 text-4xl font-black flex items-center justify-between gap-2 right-3 lg:right-5 bottom-0">
